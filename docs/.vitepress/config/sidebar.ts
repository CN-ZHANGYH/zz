...
export const sidebar: DefaultTheme.Config['sidebar'] = {
  '/categories/training/': getItems("categories/training"),
  '/categories/technic/': getItems("categories/technic"),
  '/categories/tools/': getItems("categories/tools"),
  '/categories/ctf/': getItems("categories/ctf"),

  '/courses/summary/': getItems("courses/summary"),
}
...
function getItemsByDate (path: string) {
  ...
  sync(`docs/${path}/*`, {
    ...
    // 添加年份分组
    yearGroups.unshift({
      text: `<img class="chinese-zodiac" style="position: static; vertical-align: middle; padding-bottom: 3px;" src="/img/svg/book.svg" alt="生肖">
            ${year}`,
      items: articleItems,
      collapsed: true,
    });
